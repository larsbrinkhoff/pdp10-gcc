...
#define DATA_SECTION_ASM_OP \
  (TARGET_EXTENDED ? "\t.PSECT .data/rwrite" : "")

#define RODATA_SECTION_ASM_OP \
  (TARGET_EXTENDED ? "\t.PSECT .rodata/ronly" : "")

#define BSS_SECTION_ASM_OP \
  (TARGET_EXTENDED ? "\t.PSECT .bss/rwrite" : "")

#define ASM_SECTION_END(STREAM)			\
do {						\
  if (TARGET_EXTENDED)				\
    {						\
