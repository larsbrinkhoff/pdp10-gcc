...
char *dw2_assemble_string[10];
int dw2_assemble_integer_size[10];
rtx dw2_assemble_integer_x[10];
int dw2_assemble_integer_n = 0;
HOST_WIDE_INT dw2_assemble_uleb128[10];
     ...
     rtx x;
{
  ...
  dw2_assemble_integer_size[dw2_assemble_integer_n] = size;
  dw2_assemble_integer_x[dw2_assemble_integer_n] = x;
  dw2_assemble_integer_n++;
				 ...
				 const char *comment, ...))
{
  ...
  dw2_assemble_string[dw2_assemble_integer_n] = str;
  dw2_assemble_integer_n++;
  ...
  if (flag_debug_asm && comment)
    ...
    {
#ifdef __PDP10_H__
      int old_byte_size = pdp10_string_literal_byte_size;
#endif
	...
	len += 1;
      pdp10_string_literal_byte_size = 9;
      ASM_OUTPUT_ASCII (asm_out_file, str, len);
      pdp10_string_literal_byte_size = old_byte_size;
      if (orig_len != (size_t) -1)
				      ...
				      const char *comment, ...))
{
  ...
  dw2_assemble_uleb128[dw2_assemble_integer_n] = value;
  dw2_assemble_integer_n++;
