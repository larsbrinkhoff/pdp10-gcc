...
float fltsisf (int i) { return i; }
double fltsidf (int i) { return i; }
int fixsfsi (float f) { return f; }
int fixdfsi (double d) { return d; }
unsigned int fxunssfsi (float f) { return f; }
unsigned int fxunsdfsi (double d) { return d; }
...
main()
{
  ...
  if (fltsisf (1) != 1) fail ("fltsisf 1");
  if (fltsidf (1) != 1) fail ("fltsidf 1");
  if (fixsfsi (1.42) != 1) fail ("fixsfsi 1.42");
  if (fxunssfsi (1.42) != 1) fail ("fxunssfsi 1.42");
  if (fixdfsi (1.42) != 1) fail ("fixdfsi 1.42");
  if (fxunsdfsi (1.42) != 1) fail ("fxunsdfsi 1.42");
