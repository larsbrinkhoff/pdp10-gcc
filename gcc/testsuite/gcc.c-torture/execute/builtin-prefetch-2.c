...
#ifdef __pdp10__
#define simple_file		s_file
#define simple_static_local	s_static_local
#define simple_local		s_local
#define simple_arg		s_arg
#define glob_int		g_int
#define glob_int_arr		g_int_arr
#define stat_int		s_int
#define stat_int_arr		s_int_arr
#endif
