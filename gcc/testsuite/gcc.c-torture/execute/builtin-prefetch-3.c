...
#ifdef __pdp10__
#define glob_int		gi
#define glob_int_arr		gia
#define glob_ptr_vol_int	gpvi
#define glob_vol_int		gvi
#define glob_vol_int_arr	gvia
#define glob_vol_ptr_int	gvpi
#define glob_vol_ptr_vol_int	gvpvi
#define simple_vol_global	svg
#define simple_vol_file		svf
#define stat_int_arr		sia
#define stat_ptr_vol_int	spvi
#define stat_vol_int		svi
#define stat_vol_int_arr	svia
#define stat_vol_ptr_int	svpi
#define stat_vol_ptr_vol_int	svpvi
#define vol_str			vs
#define vol_ptr_str		vps
#define ptr_vol_str		pvs
#define vol_ptr_vol_str		vpvs
#endif
