...
#ifdef __pdp10__
#define assign_arg_idx		aai
#define assign_arg_ptr		aap
#define assign_glob_idx		agi
#define assign_glob_ptr		agp
#define funccall_arg_idx	fai
#define funccall_arg_ptr	fap
#define getint			gi
#define getintcnt		gic
#define getptr			gp
#define getptrcnt		gpc
#define postdec_arg_idx		podai
#define postdec_arg_ptr		podap
#define postdec_glob_idx	podgi
#define postdec_glob_ptr	podgp
#define postinc_arg_idx		poiai
#define postinc_arg_ptr		poiap
#define postinc_glob_idx	poigi
#define postinc_glob_ptr	poigp
#define predec_arg_idx		prdai
#define predec_arg_ptr		prdap
#define predec_glob_idx		prdgi
#define predec_glob_ptr		prdgp
#define preinc_arg_idx		priai
#define preinc_arg_ptr		priap
#define preinc_glob_idx		prigi
#define preinc_glob_ptr		prigp
#endif
