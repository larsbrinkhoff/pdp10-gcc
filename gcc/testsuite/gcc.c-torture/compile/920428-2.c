...
int
gs_tlate(gs_state *pgs, floatp dx, floatp dy)
{ gs_point pt;
 int code;
...
int
gs_tform(gs_state *pgs, floatp x, floatp y, gs_point *pt)
...
int
gs_t_to_fixed(register gs_state *pgs, fixed px, fixed py)
