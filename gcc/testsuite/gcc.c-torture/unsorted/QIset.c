#define adr0adrreg1_set		A0AR1
#define adr0adrx1_set		A0AX1
#define adr0regx1_set		A0RX1
#define adrreg0adr1_set		AR0A1
#define adrreg0adrreg1_set	AR0AR1
#define adrreg0adrx1_set	AR0AX1
#define adrreg0imm1_set		AR0I1
#define adrreg0indreg1_set	AR0IR1
#define adrreg0limm1_set	AR0LI1
#define adrreg0regx1_set	AR0RX1
#define adrx0adrreg1_set	AX0AR1
#define adrx0adrx1_set		AX0AX1
#define adrx0imm1_set		AX0I1
#define adrx0regx1_set		AX0RX1
#define imm0adr1_set		I0A1
#define imm0adrreg1_set		I0AR1
#define imm0adrx1_set		I0AX1
#define imm0reg1_set		I0R1
#define imm0regx1_set		I0RX1
#define indreg0adr1_set		IR0A1
#define indreg0adrreg1_set	IR0AR1
#define indreg0adrx1_set	IR0AX1
#define indreg0imm1_set		IR0I1
#define indreg0indreg1_set	IR0IR1
#define indreg0limm1_set	IR0LI1
#define indreg0regx1_set	IR0RX1
#define limm0adrreg1_set	LI0AR1
#define limm0adrx1_set		LI0AX1
#define limm0imm1_set		LI0I1
#define limm0regx1_set		LI0RX1
#define reg0addrreg1_set	R0AR1
#define reg0adr1_set		R0A1
#define reg0adrx1_set		R0AX1
#define reg0reg1_set		R0R1
#define reg0regx1_set		R0RX1
#define regx0imm1_set		RX0I1
#define regx0adrreg1_set	RX0AR1
#define regx0adrx1_set		RX0AX1
#define regx0regx1_set		RX0RX1
