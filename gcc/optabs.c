...
static int expand_cmplxdiv_wide PARAMS ((rtx, rtx, rtx, rtx,
				       ...
				       int, enum optab_methods,
				       enum mode_class, optab));
void prepare_cmp_insn PARAMS ((rtx *, rtx *, enum rtx_code *, rtx,
  ...
  for (mode = first_mode; (int) mode <= (int) last_mode;
       mode = (enum machine_mode) ((int) mode + 1))
    {
      ...
      *p++ = '_';
      ...
      /* Ugly hack: The PDP-10 has only 6 significant characters in
         symbols.  */
      *p++ = '_';
#endif
      for (q = opname; *q; )
...
init_optabs ()
{
  ...
  /* Ugly hack: The PDP-10 has only 6 significant characters in symbols.  */

  floatsisf_libfunc = init_one_libfunc ("_flsisf");
  floatdisf_libfunc = init_one_libfunc ("_fldisf");
  floattisf_libfunc = init_one_libfunc ("_fltisf");

  floatsidf_libfunc = init_one_libfunc ("_flsidf");
  floatdidf_libfunc = init_one_libfunc ("_fldidf");
  floattidf_libfunc = init_one_libfunc ("_fltidf");

  floatsixf_libfunc = init_one_libfunc ("_flsixf");
  floatdixf_libfunc = init_one_libfunc ("_fldixf");
  floattixf_libfunc = init_one_libfunc ("_fltixf");

  floatsitf_libfunc = init_one_libfunc ("_flsitf");
  floatditf_libfunc = init_one_libfunc ("_flditf");
  floattitf_libfunc = init_one_libfunc ("_fltitf");

  fixsfsi_libfunc = init_one_libfunc ("_fxsfsi");
  fixsfdi_libfunc = init_one_libfunc ("_fxsfdi");
  fixsfti_libfunc = init_one_libfunc ("_fxsfti");

  fixdfsi_libfunc = init_one_libfunc ("_fxdfsi");
  fixdfdi_libfunc = init_one_libfunc ("_fxdfdi");
  fixdfti_libfunc = init_one_libfunc ("_fxdfti");

  fixxfsi_libfunc = init_one_libfunc ("_fxxfsi");
  fixxfdi_libfunc = init_one_libfunc ("_fxxfdi");
  fixxfti_libfunc = init_one_libfunc ("_fxxfti");

  fixtfsi_libfunc = init_one_libfunc ("_fxtfsi");
  fixtfdi_libfunc = init_one_libfunc ("_fxtfdi");
  fixtfti_libfunc = init_one_libfunc ("_fxtfti");

  fixunssfsi_libfunc = init_one_libfunc ("_fusfsi");
  fixunssfdi_libfunc = init_one_libfunc ("_fusfdi");
  fixunssfti_libfunc = init_one_libfunc ("_fusfti");

  fixunsdfsi_libfunc = init_one_libfunc ("_fudfsi");
  fixunsdfdi_libfunc = init_one_libfunc ("_fudfdi");
  fixunsdfti_libfunc = init_one_libfunc ("_fudfti");

  fixunsxfsi_libfunc = init_one_libfunc ("_fuxfsi");
  fixunsxfdi_libfunc = init_one_libfunc ("_fuxfdi");
  fixunsxfti_libfunc = init_one_libfunc ("_fuxfti");

  fixunstfsi_libfunc = init_one_libfunc ("_futfsi");
  fixunstfdi_libfunc = init_one_libfunc ("_futfdi");
  fixunstfti_libfunc = init_one_libfunc ("_futfti");
#else
...
#if 1
  /* PDP-10: short symbols.  */
  profile_function_entry_libfunc
    = init_one_libfunc ("__cpfn");
  profile_function_exit_libfunc
    = init_one_libfunc ("__cpfx");
#else
  profile_function_entry_libfunc
