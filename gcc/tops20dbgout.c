/* Output TOPS-20 format symbol table information from the GNU C compiler.
   Copyright (C) 2002 Free Software Foundation, Inc.
   Contributed by Lars Brinkhoff (lars@nocrew.org), funded by XKL, LLC.
   Derived from Dwarf 2 implementation.
...
dwarf2out_do_frame ()
{
  return (write_symbols == TOPS20_DEBUG);
}
...
/* Default version of targetm.eh_frame_section.  Note this must appear
   outside the TOPS20_DEBUGGING_INFO || DWARF2_UNWIND_INFO macro
   guards.  */
...
#if defined (TOPS20_DEBUGGING_INFO) || defined (DWARF2_UNWIND_INFO)
...
#define FUNC_BEGIN_LABEL	"B"
#endif

#ifndef FUNC_END_LABEL
#define FUNC_END_LABEL		"E"
#endif

#define FRAME_BEGIN_LABEL	"A"
#define CIE_AFTER_SIZE_LABEL	"C"
#define CIE_END_LABEL		"D"
#define CIE_LENGTH_LABEL	"F"
#define FDE_LABEL		"G"
#define FDE_AFTER_SIZE_LABEL	"H"
#define FDE_END_LABEL		"I"
#define FDE_LENGTH_LABEL	"J"
#define LINE_NUMBER_BEGIN_LABEL	"K"
#define LINE_NUMBER_END_LABEL	"M"
#define LN_PROLOG_AS_LABEL	"N"
#define LN_PROLOG_END_LABEL	"O"
#define DIE_LABEL_PREFIX	"P"
...
dwarf2out_cfi_label ()
{
  ...
  ASM_GENERATE_INTERNAL_LABEL (label, "Q", label_num++);
     ...
     int for_eh;
{
  if (cfi->dw_cfi_opc == DW_CFA_advance_loc)
    dw2_asm_output_data (1, (cfi->dw_cfi_opc
			 ...
			 "DW_CFA_advance_loc %lo",
			 cfi->dw_cfi_oprnd1.dw_cfi_offset);
  else if (cfi->dw_cfi_opc == DW_CFA_offset)
    {
      dw2_asm_output_data (1, (cfi->dw_cfi_opc
			       | (cfi->dw_cfi_oprnd1.dw_cfi_reg_num & 0x3f)),
			   "DW_CFA_offset, column %lo",
      ...
      if (augmentation[0])
	{
	  if (any_lsda_needed)
	      ...
	      if (lsda_encoding == DW_EH_PE_aligned)
		{
	      ...
	      if (fde->uses_eh_lsda)
	        {
	          ASM_GENERATE_INTERNAL_LABEL (l1, "R",
					       fde->funcdef_number);
	          dw2_asm_output_encoded_addr_rtx (
...
#define BLOCK_BEGIN_LABEL	"S"
#endif
#ifndef BLOCK_END_LABEL
#define BLOCK_END_LABEL		"T"
#endif
#ifndef BODY_BEGIN_LABEL
#define BODY_BEGIN_LABEL	"U"
#endif
#ifndef BODY_END_LABEL
#define BODY_END_LABEL		"V"
#endif
#ifndef LINE_CODE_LABEL
#define LINE_CODE_LABEL		"L"
#endif
#ifndef SEPARATE_LINE_CODE_LABEL
#define SEPARATE_LINE_CODE_LABEL	"W"
#endif

     ...
     dw_attr_ref a;
{
  if (a && AT_class (a) == dw_val_class_str)
	...
	return node->form = DW_FORM_string;
      ...
      ASM_GENERATE_INTERNAL_LABEL (label, "X", const_labelno);
      ++const_labelno;
     ...
     dw_die_ref die;
{
  ...
  if (is_symbol_die (die))
	...
	die->die_symbol = gen_internal_sym ("Y");
    }
     ...
     unsigned gensym;
{
  ...
  if (gensym) 
    retlist->ll_symbol = gen_internal_sym ("Z");
	...
	case dw_val_class_range_list:
	  {
	    ...
	    sprintf (p, "+%lo", a->dw_attr_val.v.val_offset);
...
#if 1
	  ASM_GENERATE_INTERNAL_LABEL (label, "", CODE_LABEL_NUMBER (insn));
#else
...
#endif /* TOPS20_DEBUGGING_INFO || DWARF2_UNWIND_INFO */
