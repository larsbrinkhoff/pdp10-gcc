...
#ifdef __PDP10_H__
  ASM_OUTPUT_INTERNAL_LABEL (asmfile, "Lt", 0);
#else
     ...
     const char *filename;
{
  if (filename && (lastfile == 0 || strcmp (filename, lastfile)))
...
#ifdef __PDP10_H__
      ASM_GENERATE_INTERNAL_LABEL (ltext_label_name, "Lt",
				   source_label_number);
#else
	...
	text_section ();
#ifdef __PDP10_H__
      ASM_OUTPUT_INTERNAL_LABEL (file, "Lt", source_label_number);
#else
...
{
#ifdef __PDP10_H__
  ASM_OUTPUT_INTERNAL_LABEL (asmfile, "LB", n);
#else
...
{
#ifdef __PDP10_H__
  ASM_OUTPUT_INTERNAL_LABEL (asmfile, "LE", n);
#else
